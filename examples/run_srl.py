...
from utils_srl import convert_examples_to_features, get_labels, read_examples_from_file
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    all_verb_seq_ids = torch.tensor([f.verb_seq_ids for f in features], dtype=torch.long)

...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            pos_dataset, ner_dataset, chunking_dataset, srl_dataset, onto_pos_dataset, onto_ner_dataset = load_and_cache_dev_examples(args, tokenizer, labels_pos, labels_ner, labels_onto_pos, labels_onto_ner, labels_chunking, labels_srl, pad_token_label_id, is_ft=False)

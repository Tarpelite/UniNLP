...
class AdapterBertEncoder(nn.Module):
    def __init__(self, config):
        super(AdapterBertEncoder, self).__init__()
        self.output_attentions = config.output_attentions
        self.output_hidden_states = config.output_hidden_states
...
class AdapterBertModel(BertPreTrainedModel):
...
class AdapterMTDNNModel(BertPreTrainedModel):
    def __init__(self, config, num_labels_pos, num_labels_ner, num_labels_chunking, init_last=False):
        super(AdapterMTDNNModel, self).__init__(config)
...
class MTDNNModelTaskEmbedding(BertPreTrainedModel):
    def __init__(self, config, num_labels_pos, num_labels_ner, num_labels_chunking, init_last=False):
        super(MTDNNModelTaskEmbedding, self).__init__(config)
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, 
                position_ids=None, head_mask=None, inputs_embeds=None, labels=None, task_id=0, layer_id=-1, do_alpha=True):
...
class MTDNNModelTaskEmbeddingT4(BertPreTrainedModel):
    def __init__(self, config, num_labels_pos, num_labels_ner, num_labels_chunking, init_last=False):
        super(MTDNNModelTaskEmbedding, self).__init__(config)
...
class BertForSRL(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, verb_seq_ids=None, label_BIO_ids=None, label_CRO_ids=None, label_SRL_ids=None, attention_mask=None, token_type_ids=None,
                position_ids=None, head_mask=None, inputs_embeds=None, labels=None):
...
class BertForParsingV2(BertPreTrainedModel):
    def __init__(self, config, mlp_dim, num_labels):
        super(BertForParsingV2, self).__init__(config)
        self.bert = BertModel(config)
        self.dropout = nn.Dropout(config.hidden_dropout_prob)
        self.mlp_dim = mlp_dim
